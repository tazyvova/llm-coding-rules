...
This governs prose only. It does not shorten analysis that is load-bearing, and it does not apply to issue bodies, specs, commit messages, or PR descriptions — those follow the spec format below.
